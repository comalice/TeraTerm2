...
public enum TokenType
{
    ...
    // Literals
    VARIABLE, LABEL, INTEGER, STRING,
    
    // Keywords
    FOR, NEXT, IF, THEN, ELSE, ELSEIF, ENDIF, WHILE, ENDWHILE, UNTIL, ENDUNTIL, DO, LOOP, BREAK, CONTINUE, GOTO, RETURN, END, CALL, EXIT,
